                                   ...
                                   
{
        ...
        Counter1_GLOBAL_ENABLE &= ((uint8)(~Counter1_BLOCK_EN_MASK));
    #else
        CY_SET_REG16(Counter1_COUNTER_LSB_PTR, counter);
    #endif /* (Counter1_UsingFixedFunction) */
}
#endif /* (!(Counter1_UsingFixedFunction && (CY_PSOC5A))) */
...
uint16 Counter1_ReadCounter(void) 
{
    ...
    #if(Counter1_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(Counter1_STATICCOUNT_LSB_PTR));
    #else
        return (CY_GET_REG16(Counter1_STATICCOUNT_LSB_PTR));
    #endif /* (Counter1_UsingFixedFunction) */
}
...
void Counter1_WritePeriod(uint16 period) 
{
    ...
    #else
        CY_SET_REG16(Counter1_PERIOD_LSB_PTR, period);
    #endif /* (Counter1_UsingFixedFunction) */
}
...
{
    #if(Counter1_UsingFixedFunction)
        return ((uint16)CY_GET_REG16(Counter1_PERIOD_LSB_PTR));
    #else
        return (CY_GET_REG16(Counter1_PERIOD_LSB_PTR));
    #endif /* (Counter1_UsingFixedFunction) */
}
                                   ...
                                   
{
    ...
    #else
        CY_SET_REG16(Counter1_COMPARE_LSB_PTR, compare);
    #endif /* (Counter1_UsingFixedFunction) */
}
...
{
    return (CY_GET_REG16(Counter1_COMPARE_LSB_PTR));
}
