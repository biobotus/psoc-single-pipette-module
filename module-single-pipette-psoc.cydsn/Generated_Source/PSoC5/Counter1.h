...
#define Counter1_GetInterruptSource() Counter1_ReadStatusRegister()
    ...
    void    Counter1_WriteCounter(uint16 counter) \
            ; 
#endif /* (!(Counter1_UsingFixedFunction && (CY_PSOC5A))) */
uint16  Counter1_ReadCounter(void) ;
uint16  Counter1_ReadCapture(void) ;
void    Counter1_WritePeriod(uint16 period) \
    ;
uint16  Counter1_ReadPeriod( void ) ;
#if (!Counter1_UsingFixedFunction)
    void    Counter1_WriteCompare(uint16 compare) \
        ;
    uint16  Counter1_ReadCompare( void ) \
        ;
...
#define Counter1_INIT_PERIOD_VALUE       65535u
...
#define Counter1_DEFAULT_COMPARE_MODE    5u
 ...
 *************************************/
    ...
    #define Counter1_RT1_PTR             ( (reg8 *) Counter1_CounterHW__RT1)
        ...
        #define Counter1_COUNTER_LSB_PTR     ( (reg8 *)\
            ...
            #define Counter1_STATICCOUNT_LSB     (*(reg16 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__16BIT_F0_REG )
            #define Counter1_STATICCOUNT_LSB_PTR ( (reg16 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__16BIT_F0_REG )
            #define Counter1_PERIOD_LSB          (*(reg16 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__16BIT_D0_REG )
            #define Counter1_PERIOD_LSB_PTR      ( (reg16 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__16BIT_D0_REG )
            #define Counter1_COMPARE_LSB         (*(reg16 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__16BIT_D1_REG )
            #define Counter1_COMPARE_LSB_PTR     ( (reg16 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__16BIT_D1_REG )
            #define Counter1_COUNTER_LSB         (*(reg16 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__16BIT_A0_REG )  
            #define Counter1_COUNTER_LSB_PTR     ( (reg16 *)\
                Counter1_CounterUDB_sC16_counterdp_u0__16BIT_A0_REG )
        #endif /* CY_PSOC3 */   
        ...
        #define Counter1_COUNTER_LSB_PTR     ( (reg32 *)\
            ...
            #define Counter1_STATICCOUNT_LSB     (*(reg32 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__32BIT_F0_REG )
            #define Counter1_STATICCOUNT_LSB_PTR ( (reg32 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__32BIT_F0_REG )
            #define Counter1_PERIOD_LSB          (*(reg32 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__32BIT_D0_REG )
            #define Counter1_PERIOD_LSB_PTR      ( (reg32 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__32BIT_D0_REG )
            #define Counter1_COMPARE_LSB         (*(reg32 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__32BIT_D1_REG )
            #define Counter1_COMPARE_LSB_PTR     ( (reg32 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__32BIT_D1_REG )
            #define Counter1_COUNTER_LSB         (*(reg32 *) \
                Counter1_CounterUDB_sC16_counterdp_u0__32BIT_A0_REG )  
            #define Counter1_COUNTER_LSB_PTR     ( (reg32 *)\
                Counter1_CounterUDB_sC16_counterdp_u0__32BIT_A0_REG )
    ...
    #define Counter1_AUX_CONTROLDP0 \
        (*(reg8 *) Counter1_CounterUDB_sC16_counterdp_u0__DP_AUX_CTL_REG)
    ...
    #define Counter1_AUX_CONTROLDP0_PTR \
       ...
       #define Counter1_AUX_CONTROLDP1 \
           (*(reg8 *) Counter1_CounterUDB_sC16_counterdp_u1__DP_AUX_CTL_REG)
       ...
       #define Counter1_AUX_CONTROLDP2 \
           (*(reg8 *) Counter1_CounterUDB_sC16_counterdp_u2__DP_AUX_CTL_REG)
       ...
       #define Counter1_AUX_CONTROLDP3 \
           (*(reg8 *) Counter1_CounterUDB_sC16_counterdp_u3__DP_AUX_CTL_REG)
